...
$\big(\begin{smallmatrix}
	0 & \dots & 0 & 0 & 1
\end{smallmatrix}\big)$
. Daarbij kunnen we dan $b_0^n$ en $b_{N_x - 1}^n$ gelijkstellen aan $0$ respectievelijk $T_{omgeving}$. Daarna hoeven we enkel een "bijna-tridiagonaal matrix" matrix op te lossen. Dit doen we door de methode van Thomas toe te passen. % TODO: REFERENCE
